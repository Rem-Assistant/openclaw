...
export const nl: TranslationMap = {
  ...
  newSession: {
    ...
    startAsDraft: "Beginnen als concept",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      pendingUnavailable:
        "Het verzoek om browserkoppeling is nog niet beschikbaar. Probeer het zo meteen opnieuw.",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "De thread is van branch gewisseld — controleer en verstuur opnieuw.",
    },
