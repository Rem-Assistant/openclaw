...
export const ja_JP: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "シークレット",
    incognitoDescription: "このスレッドを Gateway が再起動するまでのみ保持します",
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint:
        "中央揃えのトランスクリプトに使用する任意の CSS 幅（960px、82%、min(1280px, 82%) など）。",
      messageWidthInvalid:
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "このブラウザーはアップデート後に一度だけデバイスの承認が必要です。",
      action: "このブラウザーを保護",
      secureContextRequired:
        "このレガシーブラウザーは一時的に引き続き利用できます。HTTPS または localhost で再度開いてデバイスアイデンティティで保護してください。",
      pendingUnavailable:
  ...
  chat: {
    ...
    sessionSuggestions: {
      ...
      attachmentsUnsupported: "テキスト提案を送信する前に添付ファイルを削除してください。",
