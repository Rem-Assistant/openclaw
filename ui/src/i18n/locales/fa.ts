...
export const fa: TranslationMap = {
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "این مرورگر پس از به‌روزرسانی همچنان به تأیید یک‌بارهٔ دستگاه نیاز دارد.",
      action: "این مرورگر را ایمن کنید",
      secureContextRequired:
        "این مرورگر قدیمی به‌طور موقت در دسترس است. آن را روی HTTPS یا localhost بازکنید تا با هویت دستگاه ایمن شود.",
