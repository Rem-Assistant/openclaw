...
export const uk: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint:
        "Необовʼязкова ширина CSS для центрованого транскрипту, наприклад 960px, 82% або min(1280px, 82%).",
      messageWidthInvalid:
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      pendingUnavailable: "Запит на сполучення браузера ще недоступний. Повторіть спробу за мить.",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Гілку потоку змінено — перегляньте та надішліть знову.",
    },
    waitingForApproval: "Очікування схвалення…",
    startupStatus: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Діяти в цьому потоці можуть лише власник та учасники.",
    },
    sessionSuggestions: {
      suggest: "Запропонувати",
