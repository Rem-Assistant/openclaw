...
export const de: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthInvalid:
        "Gib eine CSS-Breite an, z. B. 960px, 82%, min(1280px, 82%) oder calc(100% - 2rem).",
    },
    sidebarPrefs: {
      title: "Seitenleiste",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "Dieser veraltete Browser bleibt vorübergehend verfügbar. Öffne ihn erneut über HTTPS oder localhost, um ihn mit der Geräteidentität abzusichern.",
      pendingUnavailable:
        "Die Browser-Kopplungsanfrage ist noch nicht verfügbar. Versuche es gleich erneut.",
