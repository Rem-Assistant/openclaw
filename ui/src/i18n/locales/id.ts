...
export const id: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint:
        "Lebar CSS opsional untuk transkrip yang berada di tengah, seperti 960px, 82%, atau min(1280px, 82%).",
      messageWidthInvalid:
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      pendingUnavailable: "Permintaan pemasangan peramban belum tersedia. Coba lagi sebentar lagi.",
  ...
  chat: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Hanya pemilik thread dan anggota yang dapat bertindak dalam thread ini.",
    },
    sessionSuggestions: {
      suggest: "Sarankan",
