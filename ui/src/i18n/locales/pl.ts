...
export const pl: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint:
        "Opcjonalna szerokość CSS wyśrodkowanego zapisu, np. 960px, 82% lub min(1280px, 82%).",
      messageWidthInvalid:
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Wątek zmienił gałęzie — przejrzyj i wyślij ponownie.",
    },
    waitingForApproval: "Oczekiwanie na zatwierdzenie…",
    startupStatus: {
    ...
    sessionSuggestions: {
      suggest: "Zasugeruj",
      suggestMessage: "Zasugeruj wiadomość",
      attachmentsUnsupported: "Usuń załączniki przed przesłaniem sugestii tekstowej.",
      sendNow: "Wyślij teraz sugestię użytkownika {author}",
      queue: "Dodaj do kolejki sugestię użytkownika {author}",
      edit: "Edytuj sugestię użytkownika {author}",
      dismiss: "Odrzuć sugestię użytkownika {author}",
      typing: "{name} pisze…",
    ...
    composer: {
      ...
      offlineQueuedHint:
        "Offline — w kolejce: {count}; wiadomości zostaną wysłane po przywróceniu połączenia.",
