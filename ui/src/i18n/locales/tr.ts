...
export const tr: TranslationMap = {
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "İş parçacığı dalları değiştirdi — gözden geçirin ve yeniden gönderin.",
    },
    waitingForApproval: "Onay bekleniyor…",
    startupStatus: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Bu iş parçacığında yalnızca iş parçacığı sahibi ve üyeler işlem yapabilir.",
    },
    sessionSuggestions: {
      suggest: "Öner",
