...
export const ko: TranslationMap = {
  ...
  sessionsView: {
    ...
    approvalNeeded: "승인 필요",
    queuedMessage: "{count}개의 메시지가 전송 대기 중",
    queuedMessages: "{count}개의 메시지가 전송 대기 중",
  ...
  profilePage: {
    ...
    identity: {
      title: "ID",
      menuLabel: "신원 메뉴",
      menuButtonLabel: "{name}의 신원 및 앱 메뉴",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "이 레거시 브라우저는 임시로 사용할 수 있습니다. HTTPS 또는 localhost로 다시 열어 기기 신원으로 보안을 설정하세요.",
      pendingUnavailable:
  ...
  chat: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "이 스레드에서는 스레드 소유자와 구성원만 작업할 수 있습니다.",
    },
    sessionSuggestions: {
      suggest: "제안",
      suggestMessage: "메시지 제안",
      attachmentsUnsupported: "텍스트 제안을 제출하기 전에 첨부 파일을 제거하세요.",
      sendNow: "{author}의 제안을 지금 보내기",
      queue: "{author}의 제안 대기열에 추가",
      edit: "{author}의 제안 편집",
      dismiss: "{author}의 제안 무시",
      typing: "{name}님이 입력 중…",
