...
export const es: TranslationMap = {
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "Este navegador antiguo sigue disponible temporalmente. Vuelve a abrirlo mediante HTTPS o localhost para protegerlo con la identidad del dispositivo.",
      pendingUnavailable:
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "El hilo cambió de rama — revisa y reenvía.",
    },
    waitingForApproval: "Esperando aprobación…",
    startupStatus: {
    ...
    composer: {
      ...
      offlineQueuedHint:
        "Sin conexión — {count} en cola; los mensajes se enviarán cuando regrese la conexión.",
