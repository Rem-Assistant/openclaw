...
const CLAUDE_5_OPTIONAL_ADAPTIVE_THINKING_PROFILE = {
  levels: [
    { id: "off" },
    { id: "minimal" },
    { id: "low" },
...
export const CLAUDE_OPUS_5_THINKING_PROFILE = CLAUDE_5_OPTIONAL_ADAPTIVE_THINKING_PROFILE;
export const CLAUDE_SONNET_5_THINKING_PROFILE = CLAUDE_5_OPTIONAL_ADAPTIVE_THINKING_PROFILE;
