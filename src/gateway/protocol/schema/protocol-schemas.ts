...
export const ProtocolSchemas = {
  ...
  TalkVoicesParams: TalkVoicesParamsSchema,
  TalkVoicesResult: TalkVoicesResultSchema,
  ...
  TalkSpeakCancelParams: TalkSpeakCancelParamsSchema,
  TalkSpeakCancelResult: TalkSpeakCancelResultSchema,
